...
require_once ("../Modelo/BDCliente.php");

    $objCliente = new BDCliente();
    $objectClient = $objCliente->ReporteVentaPorCliente();   
    ...
    <div class="collapse navbar-collapse h-100 " id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="../View/Administrator_View.php">Home <span class="sr-only">(current)</span></a>
            </li>
...
<table class="table table-striped">
    ...
    <?php 
        ...
        foreach ($objectClient as $key ) { 
    ?>                   
    <tbody>
            <td><?php echo $count?></td>
            <td><?php echo $key['Anio'] ?></td>
            <td><?php echo $key['Cliente']?></td>
            <td><?php echo $key['Compras'] ?></td>
    </tbody>
        <?php  $count++; } ?>
</table>
</div>
