...
require_once ("../Modelo/BDCategoria.php");

    $objCategoria = new BDCategoria();
    $objectCatego = $objCategoria->ReportePorCategoria();   
...
<table class="table table-striped">
    ...
    <?php 
        ...
        foreach ($objectCatego as $key ) { 
    ?>                   
    <tbody>
            <td><?php echo $count?></td>
            <td><?php echo $key['Departamentos'] ?></td>
            <td><?php echo $key['productosVendidos'] ?></td>
    </tbody>
        <?php  $count++; } ?>
</table>
</div>
